...
private[immutable] abstract class ChampBaseIterator[T <: Node[T]] {
  ...
  private val nodes: Array[T] = new Array[Object](MaxDepth).asInstanceOf[Array[T]]
...
private[immutable] abstract class ChampBaseReverseIterator[T <: Node[T]] {
  ...
  private val nodeStack: Array[T] = new Array[Object](MaxDepth + 1).asInstanceOf[Array[T]]
